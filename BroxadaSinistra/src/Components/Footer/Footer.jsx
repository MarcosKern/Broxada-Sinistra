...
export default function Footer() {
  return (
    <footer>
      <img
        src={Logo}
        alt="Logo do Broxada Sinistra Shippuden"
        width={50}
        height={50}
      />
      <section className="social-medias">
        <a
          ...
          rel="noreferrer"
        >
          <img src={Instagram} alt="Logo do Instagram" width={50} height={50} />
        </a>
        <a
          ...
          rel="noreferrer"
        >
          <img src={Youtube} alt="Logo do Youtube" width={50} height={50} />
        </a>
        <a
          ...
          rel="noreferrer"
        >
          <img src={Spotify} alt="Logo do Spotify" width={50} height={50} />
        </a>
        <a
          ...
          rel="noreferrer"
        >
          <img src={Tiktok} alt="Logo do TikTok" width={50} height={50} />
        </a>
        <a
          ...
          rel="noreferrer"
        >
          <img src={Deezer} alt="Logo da Deezer" width={50} height={50} />
        </a>
      </section>
      <small>
        Alfra Estúdios e Broxada Sinistra ® Todos direitos reservados. Design e
        desenvolvido por{' '}
        <a
